...
(function (scenes) {
    var SlotMachine = (function (_super) {
        ...
        SlotMachine.prototype.start = function () {
            ...
            this._bet1Button = new objects.Button("Bet1Button", 120, 400, false);
            this.addChild(this._bet1Button);
            this._bet1Button.on("click", this._bet1ButtonClick, this);
            // add Bet10Button to the scene
            this._bet10Button = new objects.Button("Bet10Button", 170, 400, false);
            this.addChild(this._bet10Button);
            this._bet10Button.on("click", this._bet10ButtonClick, this);
            // add Bet20Button to the scene
            this._bet20Button = new objects.Button("Bet20Button", 220, 400, false);
            this.addChild(this._bet20Button);
            this._bet20Button.on("click", this._bet20ButtonClick, this);
            // add Bet50Button to the scene
            this._bet50Button = new objects.Button("Bet50Button", 270, 400, false);
            this.addChild(this._bet50Button);
            this._bet50Button.on("click", this._bet50ButtonClick, this);
            // add Bet100Button to the scene
            this._bet100Button = new objects.Button("Bet100Button", 320, 400, false);
            this.addChild(this._bet100Button);
            this._bet100Button.on("click", this._bet100ButtonClick, this);
            // add SpinButton to the scene
            this._spinButton = new objects.Button("SpinButton", 400, 380, false);
            this.addChild(this._spinButton);
            this._spinButton.on("click", this._spinButtonClick, this);
            //add reset button            
            this._reset = new objects.Button("Reset", 0, 380, false);
            this.addChild(this._reset);
            this._reset.on("click", this._resetButtonClick, this);
            //add close button
            this._close = new objects.Button("close", 520, 20, false);
            ...
            this._creditsText = new objects.Label(this.playerMoney.toString(), "14px Consolas", "#ff0000", 100, 300, false);
            this._creditsText.textAlign = "right";
            this.addChild(this._creditsText);
            // add Bet Text to the scene
            this._betText = new objects.Label(this.playerBet.toString(), "14px Consolas", "#ff0000", 250, 300, false);
            this._betText.textAlign = "right";
            this.addChild(this._betText);
            // add Result Text to the scene
            this._resultText = new objects.Label(this.winnings.toString(), "14px Consolas", "#ff0000", 350, 300, false);
        ...
        SlotMachine.prototype._determineWinnings = function () {
            if (this._bars == 0) {
                if (this._pears == 3) {
                    ...
                    this.winnings = this.playerBet * 0;
                }
                console.log("Win!");
            }
            else {
        ...
        SlotMachine.prototype._initializeBitmapArray = function () {
            ...
            for (var reel = 0; reel < 3; reel++) {
                ...
                this._reels[reel].x = 40 + (reel * 150);
